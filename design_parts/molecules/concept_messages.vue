<template>
  <div class="concept_messages">
    <div class="concept_message" v-for="message in $static.messages">
      <div class="text">
        <div class="text-box">
          <heading :heading="message.heading" data-aos="fade-down"/>
          <p data-aos="fade-up">
            <span v-for="text in message.main_text">
              {{ text }}
              <br>
            </span>
          </p>
      ...
      <div class="svg" data-aos="fade-up-left">
